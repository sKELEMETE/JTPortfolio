  ...
  return (
    <>
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 backdrop-blur-xl rounded-2xl shadow-2xl"></div>
        ...
        <div className="relative flex flex-col items-center gap-y-4 p-4">
          ...
          <a
            ...
            className="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-900 rounded-xl flex items-center justify-center shadow-lg border border-gray-600/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-1 hover:shadow-2xl"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <a
            ...
            rel="noopener noreferrer"
            style={{ clipPath: "url(#squircleClip)" }}
            className="w-14 h-14 bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-xl flex items-center justify-center shadow-lg border border-indigo-500/50 cursor-pointer transform transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-1 hover:shadow-2xl"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
