...
export const projectsData = [
  ...
  },
  {
    ...
    description: "Stock Market Tracker is a Flutter app that shows live stock prices, trend updates, and real time data from an API. It includes AI integration to give you simple insights, price summaries, and quick guidance based on market movement. It delivers clear information in a clean and fast layout.",
    img: "",
    link: "",
    status: "Coding Phase",
  },
  {
    title: "Pharmatrack",
    description: "PharmaTrack is designed by showing medication information by displaying medicine data such as uses, expiry dates, and necessary cautions.",
    img: pharmatrack,
